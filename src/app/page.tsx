      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pt-20 pb-24 sm:pt-28 sm:pb-32">
          <div className="max-w-3xl">
            ...
            >
              Chameleon Golf aggregates Golf Digest, Golfweek, GOLF Magazine, and
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2 text-sm" style={{ color: "var(--cg-text-muted)" }}>
                    ...
                    Sign up free to view full list rankings and course details
                  </div>
                  <Link
                    href="/explore"
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="text-center">
            ...
            >
              ...
              in time. Chameleon Golf is dynamic. It synthesizes multiple sources
            ...
            {[
              {
                ...
                desc: "We pull rankings from 4 trusted publications. Each source is weighted by authority, and the best ranking per source feeds into a composite Chameleon Score.",
              },
              {
              ...
              {
                icon: Trophy,
                title: "The Chameleon Score",
                desc: "Our algorithm combines expert rankings with community ratings, weighted by your profile. A score that adapts like a chameleon to your taste.",
              },
            ].map((item) => (
              <div
                key={item.title}
